...
class ItemsController extends Controller
{
            ...
            if(Yii::$app->request->isAjax){
                ...
                if (isset($_FILES) && $this->module->settings['articleThumb']) {
                    ...
                    if ($model->image && $model->validate(['image'])) {
                        $model->image = Image::upload($model->image, 'portfolio');
                    } else {
                        $model->image = '';
                    }
                }
                ...
                if ($model->save()) {
                    $this->flash('success', Yii::t('easyii/portfolio', 'Article created'));
    ...
    public function actionEdit($id)
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            if(Yii::$app->request->isAjax){
                ...
                if ($model->save()) {
                    $this->flash('success', Yii::t('easyii/portfolio', 'Article updated'));
                    return $this->redirect(['/admin/'.$this->module->id.'/items/edit', 'id' => $model->primaryKey]);
                } else {
    ...
    public function actionDelete($id)
    {
        ...
        return $this->formatResponse(Yii::t('easyii/portfolio', 'Article deleted'));
    }
