...
namespace app\modules\eu\models;

use app\modules\eu\Finder;
use app\modules\eu\helpers\Password;
use app\modules\eu\Mailer;
use app\modules\eu\EuModule;
use app\modules\eu\traits\ModuleTrait;
use Yii;
...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    {
        return in_array($this->id, $this->module->admins);
    }
