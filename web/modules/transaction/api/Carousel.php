<?php
namespace app\modules\slider\api;

use Yii;
use yii\easyii\components\API;
use yii\easyii\helpers\Data;
use app\modules\slider\models\Carousel as CarouselModel;
use yii\helpers\Html;
use yii\helpers\Url;

/**
 * Carousel module API
 * @package app\modules\slider\api
...
class Carousel extends API
{
    ...
    public function api_widget($width, $height, $clientOptions = [])
    {
        if(!count($this->_items)){
            return LIVE_EDIT ? Html::a(Yii::t('easyii/slider/api', 'Create carousel'), ['/admin/carousel/a/create'], ['target' => '_blank']) : '';
        }
        ...
        $widget = \app\widgets\Carousel::widget([
            'options' => ['class' => 'slide'],
