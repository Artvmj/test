<?php
namespace app\modules\emeraldnews\models;
...
class News extends \yii\easyii\components\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'short' => Yii::t('easyii/emeraldnews', 'Short'),
    ...
    public function beforeSave($insert)
    {
        if (parent::beforeSave($insert)) {
            $settings = Yii::$app->getModule('admin')->activeModules['emeraldnews']->settings;
