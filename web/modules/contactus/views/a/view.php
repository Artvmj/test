...
$this->title = Yii::t('easyii/contactus', 'View feedback');
$this->registerCss('.feedback-view dt{margin-bottom: 10px;}');

if($model->status == Feedback::STATUS_ANSWERED) {
    $this->registerJs('$(".send-answer").click(function(){return confirm("'.Yii::t('easyii/contactus', 'Are you sure you want to resend the answer?').'");})');
}
?>
...
<dl class="dl-horizontal feedback-view">
    ...
    <dt><?= Yii::t('easyii/contactus', 'Phone') ?></dt>
    <dd><?= $model->phone ?></dd>
    <?php endif; ?>
...
<hr>
<h2><small><?= Yii::t('easyii/contactus', 'Answer') ?></small></h2>
